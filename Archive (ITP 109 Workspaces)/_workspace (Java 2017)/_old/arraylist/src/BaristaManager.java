...
public class BaristaManager {
	...
	private static void printBaristas(Barista[] baristas) {
		for(int i = 0; i < baristas.length; i++){
			System.out.println(i + ": " + baristas[i].getName());
		}
	}

	private static void addBarista(Barista[] baristas) {
	...
	private static void removeBarista(Barista[] baristas) {
		...
		if(index < 0 || index > baristas.length - 1){
